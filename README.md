...
Il main thread si occupa dei calcoli che vanno eseguiti una sola volta per iterazione, come ad esempio il calcolo del vettore Y, o di altri fattori che non dipendono nè dal nodo sul quale vogliamo calcolare il pagerank, nè dal numero di iterazione.
